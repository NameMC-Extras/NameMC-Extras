...
waitForFunc("supabase_data", async () => {
    getSpecialCapes()
                ...
                <div class="col">
                    <select class="form-select" id="officialcapes" name="officialcapes">
                        <optgroup label="Common">
                            <option data-value="2340c0e03dd24a11b15a8b33c2a7e9e32abb2051b2481d0ba7defd635ca7a933">Migrator</option>
                            <option data-value="f9a76537647989f9a0b6d001e320dac591c359e9e61a31f4ce11c88f207f0ad4">Vanilla</option>
                            <option data-value="afd553b39358a24edfe3b8a9a939fa5fa4faa4d9a9c3d6af8eafb377fa05c2bb">Cherry Blossom
                            </option>
                        </optgroup>
                        <optgroup label="Minecon">
                            <option data-value="e7dfea16dc83c97df01a12fabbd1216359c0cd0ea42f9999b6e97c584963e980">Minecon 2016</option>
                            <option data-value="b0cc08840700447322d953a02b965f1d65a13a603bf64b17c803c21446fe1635">Minecon 2015</option>
                            <option data-value="153b1a0dfcbae953cdeb6f2c2bf6bf79943239b1372780da44bcbb29273131da">Minecon 2013</option>
                            <option data-value="a2e8d97ec79100e90a75d369d1b3ba81273c4f82bc1b737e934eed4a854be1b6">Minecon 2012</option>
                            <option data-value="953cac8b779fe41383e675ee2b86071a71658f2180f56fbce8aa315ea70e2ed6">Minecon 2011</option>
                        </optgroup>
                        <optgroup label="Special">
                            <option data-value="17912790ff164b93196f08ba71d0e62129304776d0f347334f8a6eae509f8a56">Realms Mapmaker
                            </option>
                            <option data-value="9e507afc56359978a3eb3e32367042b853cddd0995d17d0da995662913fb00f7">Mojang (New)</option>
                            <option data-value="5786fe99be377dfb6858859f926c4dbc995751e91cee373468c5fbf4865e7151">Mojang</option>
                            <option data-value="8f120319222a9f4a104e2f5cb97b2cda93199a2ee9e1585cb8d09d6f687cb761">Mojang (Classic)
                            </option>
                            <option data-value="ae677f7d98ac70a533713518416df4452fe5700365c09cf45d0d156ea9396551">Mojira Moderator
                            </option>
                            <option data-value="1bf91499701404e21bd46b0191d63239a4ef76ebde88d27e4d430ac211df681e">Translator</option>
                            <option data-value="2262fb1d24912209490586ecae98aca8500df3eff91f2a07da37ee524e7e3cb6">Translator (Chinese)
                            </option>
                            <option data-value="ca35c56efe71ed290385f4ab5346a1826b546a54d519e6a3ff01efa01acce81">Cobalt</option>
                            <option data-value="3efadf6510961830f9fcc077f19b4daf286d502b5f5aafbd807c7bbffcaca245">Scrolls</option>
                        </optgroup>
                        <optgroup label="Custom">
                            <option data-value="5048ea61566353397247d2b7d946034de926b997d5e66c86483dfb1e031aee95">Turtle</option>
                            <option data-value="2056f2eebd759cce93460907186ef44e9192954ae12b227d817eb4b55627a7fc">Birthday</option>
                            <option data-value="6a7cf0eb5cfe7e7c508b364e32916dfd28d164e7bf6d92c6ea7811b82451e760">Valentine</option>
                            <option data-value="bcfbe84c6542a4a5c213c1cacf8979b5e913dcb4ad783a8b80e3c4a7d5c8bdac">dannyBstyle</option>
                            <option data-value="70efffaf86fe5bc089608d3cb297d3e276b9eb7a8f9f2fe6659c23a2d8b18edf">Millionth Customer
                            </option>
                            <option data-value="d8f8d13a1adf9636a16c31d47f3ecc9bb8d8533108aa5ad2a01b13b1a0c55eac">Prismarine</option>
                            <option data-value="23ec737f18bfe4b547c95935fc297dd767bb84ee55bfd855144d279ac9bfd9fe">JulianClark</option>
                            <option data-value="2e002d5e1758e79ba51d08d92a0f3a95119f2f435ae7704916507b6c565a7da8">MrMessiah</option>
                            <option data-value="ca29f5dd9e94fb1748203b92e36b66fda80750c87ebc18d6eafdb0e28cc1d05f">cheapsh0t</option>
                        </optgroup>
                        <optgroup label="Previous or Temporary Capes">
                            <option data-value="fd14214cd8073059e93d9c626260f5df85e5a959181537119df56cadaf5002cc">Bacon</option>
                            <option data-value="2ada7acf3e0ef436f350e21af91a774b7cd95309c53668a441eeacec88ca4211">Christmas 2010
                            </option>
                            <option data-value="d1f20f8534f9f58a3a0a26586d5615f513add564809986334b7f247593425ee3">New Year's 2011
                            </option>
                            <option data-value="938155dd83118a3993a22579649fab313cdb06073029c3839843d58fad06ebb2">Xbox 360 1st Birthday
                                Cape</option>
                        </optgroup>
                        <optgroup label="Bedrock Capes">
                            <option data-value="99aba02ef05ec6aa4d42db8ee43796d6cd50e4b2954ab29f0caeb85f96bf52a1">Founder's Cape
                            </option>
                            <option data-value="28de4a81688ad18b49e735a273e086c18f1e3966956123ccb574034c06f5d336">Pancape</option>
                        </optgroup>
                    </select>
                </div>`;

                    currentCape = "https://textures.minecraft.net/texture/" + $('#officialcapes :selected').data('value');
                    ...
                    <div class="col">
                        ...
                        return `
                                    <optgroup label="${categoryName}">
                                        ${capes.sort((a, b) => a.name.localeCompare(b.name)).map(c => `<option data-value="${c.image_src}">${c.name}</option>`).join("")}
                                    </optgroup>
                                `;
                    }).join("")}
                        </select>
