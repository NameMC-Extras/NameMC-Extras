  ...
  waitForUUID(async () => {
    ...
    views.outerHTML += `
      ...
      <div class="row no-gutters">
        ...
        <div class="col-12 order-lg-2 col-lg"><a href="https://mcuserna.me/${uuid}" target="_blank">mcuserna.me</a>, <a href="https://capes.me/${uuid}" target="_blank">capes.me</a>, <a href="https://laby.net/@${uuid}" target="_blank">LABY.net</a>, <a href="https://livzmc.net/user/${uuid}" target="_blank">LivzMC</a>, <a href="https://plancke.io/hypixel/player/stats/${uuid}" target="_blank">Plancke</a></div>
      </div>
    `;
